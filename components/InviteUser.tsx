...
const InviteUser: React.FC<InviteUserProps> = ({ onBack }) => {
  return (
    <div className="flex flex-col w-full max-w-3xl">
      ...
      <div className="flex items-center gap-[var(--space-md)] mb-[var(--space-lg)]">
        ...
        <h1 className="text-[length:var(--font-size-xl)] font-bold text-[var(--color-text-primary)]">Invite user</h1>
      </div>
        ...
        <div className="card-body p-[var(--space-lg)] gap-[var(--space-lg)]">
            ...
            <div className="form-control w-full">
              <label className="label pl-0 pt-0">
                <span className="label-text font-bold text-[var(--color-text-primary)] text-[length:var(--font-size-sm)]">Role</span>
              </label>
            ...
            <div className="form-control w-full">
              <label className="label pl-0 pt-0">
                <span className="label-text font-bold text-[var(--color-text-primary)] text-[length:var(--font-size-sm)]">Email Address</span>
              </label>
              <div className="relative">
                <input 
                  type="email" 
                  placeholder="Email Address"
                  className="input input-bordered w-full text-[length:var(--font-size-base)] text-[var(--color-text-primary)] pr-24" 
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center gap-1.5 pointer-events-none">
                  <div className="w-8 h-8 rounded-full bg-[var(--color-accent-subtle)] flex items-center justify-center">
                      <Icons.Users className="w-4 h-4 text-[var(--color-accent)]" />
                  </div>
